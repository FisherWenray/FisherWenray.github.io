...
.page{width:min(1200px,94vw);margin:28px auto 34px}
    ...
    .article-header{padding:36px 38px 26px;text-align:center;border-bottom:1px solid rgba(197,179,88,.24);background:linear-gradient(155deg, rgba(197,179,88,.12), rgba(255,255,255,.96))}
    .article-title{font-family:'Noto Serif SC',serif;font-size:clamp(28px,4.5vw,42px);color: #c5b358;line-height:1.3;margin-bottom:12px}
    ...
    .article-content{font-family:-apple-system,'PingFang SC','Microsoft YaHei',sans-serif;color:#000;line-height:1.82;font-size:17px;max-width:780px;margin:0 auto}
    .article-content h1,.article-content h2,.article-content h3,.article-content h4,.article-content h5,.article-content h6{color: #c5b358;font-weight:700;margin-top:1.5em;margin-bottom:1em;font-family:-apple-system,'PingFang SC','Microsoft YaHei',sans-serif}
    .article-content h1{display:none}
    .article-content h2{border-bottom:1px solid rgba(197,179,88,.45);padding-bottom:5px;font-size:clamp(22px,2.8vw,30px)}
    .article-content h3{font-size:clamp(19px,2.4vw,24px)}
    .article-content p{margin-bottom:1.28em;text-align:justify}
    .article-content a{color:var(--gold);text-decoration:none;border-bottom:1px dashed var(--gold)}
    .article-content strong{color:var(--gold);padding:0 2px;font-weight:700}
    .article-content blockquote{border-left:4px solid var(--gold);padding:10px 20px;background:rgba(197,179,88,.08);color:#555;font-style:italic;margin:20px 0;border-radius:0 var(--radius-md) var(--radius-md) 0}
    ...
    .article-content pre{background:#e2e9ef;color:#2c3e50;border:1px solid var(--gold);border-radius:var(--radius-md);padding:20px;margin:25px 0;overflow-x:auto}
    .article-content pre::before{content:'CODE';display:block;font-size:10px;color: #c5b358;margin-bottom:12px;opacity:.5;letter-spacing:2px;font-weight:700;font-family:'JetBrains Mono',monospace}
    ...
    .article-content img{max-width:100%;height:auto;border-radius:var(--radius-md);margin:20px auto;display:block}
    ...
    [data-theme='dark'] .article-header{background:rgba(197,179,88,.08)!important;border-bottom:1px solid rgba(197,179,88,.32)!important}
    ...
    [data-theme='dark'] .article-content strong{color:var(--gold)!important;text-shadow:0 0 10px rgba(197, 179, 88, .3)!important}
