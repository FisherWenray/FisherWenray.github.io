...
<head>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .article-content blockquote{border-left:4px solid var(--gold);padding:10px 20px;background:rgba(197,179,88,.08);color:#555;font-style:italic;margin:20px 0;border-radius:0 4px 4px 0}
    ...
    .article-content pre{background:#e2e9ef;color:#2c3e50;border:1px solid var(--gold);border-radius:8px;padding:20px;margin:25px 0;overflow-x:auto}
    ...
    [data-theme='dark']{--primary:#004E8C;--primary-rgb:0,78,140;--deep: #000000;--gold: #C5B358;--ink:#fff;--ink-soft:#A0B3C6;--paper: #000000;--surface:rgba(0,78,140,.08);--line:rgba(0,78,140,.4);--shadow:0 8px 32px 0 rgba(0,0,0,.8)}
    [data-theme='dark'] body{background:radial-gradient(circle at 50% -20%, rgba(197, 179, 88, .15) 0%, transparent 50%),radial-gradient(circle at 100% 100%, rgba(197, 179, 88, .05) 0%, transparent 50%),var(--paper)!important;color:var(--ink)!important}
    ...
    [data-theme='dark'] .nav-links a:hover,[data-theme='dark'] .nav-links a.active{color:var(--gold)!important;background:rgba(197, 179, 88, .1)!important;box-shadow:0 0 20px rgba(197, 179, 88, .2)!important;border-color:rgba(197, 179, 88, .4)!important}
